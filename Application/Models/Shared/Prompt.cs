...
namespace TradingAppMvc.Application.Models.Shared
{
    public class Prompt
    {
        ...
        public List<SelectOptionPrompt> Options { get; private set; }
        public Dictionary<string, object> Attributes { get; private set; } = new();

        public void SetSelectOption(IEnumerable<SelectOptionPrompt> options){
        ...
        public static Prompt CreateSelectPrompt(string id, string name, IEnumerable<SelectOptionPrompt> options)
        {
        ...
        public Prompt SetPlaceholder(string placeholder)
        {
            if (Options.Any())
            {
                Options.Insert(0, new SelectOptionPrompt().SetPlaceholder(placeholder));
            }
